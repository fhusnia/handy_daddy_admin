  ...
  export default {
    ...
    methods: {
      ...
      async loadHomeWhy(id) {
        try {
          await this.$store.dispatch('homewhyuss/getHomewhyusId', id)
          const whyus = this.$store.getters['homewhyuss/getHomewhyusId']
          const savedData = JSON.parse(localStorage.getItem('getHomewhyus'))
      ...
      async save() {
        ...
        if (result.isConfirmed) {
          ...
          try {
            if (this.homewhyusID) {
              this.updateHomewhyus({
                id: this.homewhyusID,
                homewhyus: homewhydataList,
              })
            } else {
              await this.createHomewhyus(homewhydataList)
            }
